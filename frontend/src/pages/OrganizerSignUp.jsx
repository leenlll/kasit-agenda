    ...
    <div className="organizer-signup-page">
      ...
      <main className="signup-content">
        ...
        >
          ...
          <input type="text" name="organization" placeholder="Enter organization name" onChange={handleChange} />
        ...
        <p className="signin-text">
          Already have an account? <Link to="/organizer-signin">Sign In Here</Link>
        </p>
      </main>
    </div>
  );
