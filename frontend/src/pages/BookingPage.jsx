        ...
        >
          ...
          <motion.form onSubmit={handleSubmit}>
            ...
            <select name="location" value={formData.location} onChange={handleChange} required>
              ...
              <option value="LAB103">Lab 103</option>
              <option value="LAB104">Lab 104</option>
              <option value="LAB105">Lab 105</option>
              <option value="LAB106">Lab 106</option>
              <option value="LAB107">Lab 107</option>
              <option value="LAB201">Lab 201</option>
              <option value="LAB202">Lab 202</option>
              <option value="LAB203">Lab 203</option>
              <option value="LAB204">Lab 204</option>
              <option value="LAB205">Lab 205</option>
              <option value="LAB206">Lab 206</option>
              <option value="LAB207">Lab 207</option>
              <option value="LAB301">Lab 301</option>
              <option value="LAB302">Lab 302</option>
              <option value="LAB303">Lab 303</option>
              <option value="LAB304">Lab 304</option>
              <option value="LAB305">Lab 305</option>
              <option value="LAB306">Lab 306</option>
              <option value="LAB307">Lab 307</option>
            </select>
